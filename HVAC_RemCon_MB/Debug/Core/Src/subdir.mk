...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/io_core.cyclo ./Core/Src/io_core.d ./Core/Src/io_core.o ./Core/Src/io_core.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/modbus_tcp.cyclo ./Core/Src/modbus_tcp.d ./Core/Src/modbus_tcp.o ./Core/Src/modbus_tcp.su ./Core/Src/nodeid.cyclo ./Core/Src/nodeid.d ./Core/Src/nodeid.o ./Core/Src/nodeid.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/sysstatus.cyclo ./Core/Src/sysstatus.d ./Core/Src/sysstatus.o ./Core/Src/sysstatus.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/webserver.cyclo ./Core/Src/webserver.d ./Core/Src/webserver.o ./Core/Src/webserver.su
